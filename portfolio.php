...
//Var, Display, Titulo, Descrição, ano, miniatura, grande, link
//Sites
$novometodo = array("novometodo", "Novometodo", "Novometodo","Esse site era um tópico da Consultoria de Marketing realizada para empresa, que tinha por objetivo melhorar a orientação de vendas","2008", "site_novometodo.jpg","sites/site_novometodo_screenshots800x600.jpg", "[Fora do Ar]");
$paulista = array("paulista", "Paulista Jr", "Paulista Junior Projeto & Consultoria", "Site criado quando eu era Consultor de Marketing da empresa.", "2007", "site_paulistajr.jpg","sites/site_paulistajr_screenshots800x600.jpg", "[Fora do Ar]");
$aaamg = array("aaamg", "AAAMG", "Associação Atlética Acadêmica Mané Garrincha","Site realizado utilzando as ferramentas Flash e para o 3d anim8or. Com um design totalmente arrojado e muito a frente do seu tempo.","2007", "site_aaamg.jpg","sites/site_aaamg_screenshots800x600.jpg", "www.aaamg.com.br"); 
$dookie = array("dookie", "Banda Dookie", "Banda Dookie", "Site realizado utilizando as ferramentas Flash e para o 3d anim8or. Com um design totalmente arrojado e muito a frente do seu tempo.", "2005", "site_dookie.jpg","sites/site_bandadookie_screenshots800x600.jpg", "[Fora do Ar]");

//Sistema
$email = array("email", "Sis Email", "Sistema de Envio de Email Financeiro", "Um super gerente de email para seu vtigerCRM. Este sistema foi criado inicialmente para a Dynamo Publicidade, devido ao impacto positivo na empresa decidi fazer dele um produto.</p><p> Aproveite, esse sistema está a venda no site, visite a página de venda e conheça mais</p>", "fev/2009", "sistema_email.jpg", "sistemas/sistema-email1.jpg", "www.franciscomatelli.com/vtiger/email");
...
//Jogos
$arqueiro = array("arqueiro", "Arqueiro Bow", "Arqueiro Bow", "Um jogo criado em parceria com Samuel Kato [Novometodo]. Um jogo dinâmico, aonde o jogador é um personagem que combate em tempo real e online outro arqueiros. Flash e PHP", "2007", "game_arqueiro.jpg", "jogos/game_arqueirobow_screenshots800x600.jpg", " [Procurando Host] ");
$futebol = array("futebol", "Fute Bolon", "Fute Bolon Line", "Jogo de Futebol Massive Multiplayer Online. O projeto foi totalmente concebido e desenvolvido por mim, desde layout, engine e php. O projeto precisou de uma reformulação devido a uma mudança estratégica de troca de plataforma, porém não tive tempo para continuar trabalhando nele.", "2006", "game_futebolonline.jpg", "jogos/game_futebolonline_screenshots800x600.jpg", "");
$violenchico = array("violenchico", "Violenchico", "Violenchico", "Um super jogo de luta desenvolvido em flash, aonde os personagem eram os meus amigo feito em desenho animado. Milhares de linhas de código desenvolvidas por mim, caricaturas de mais de 8 amigos, porém o projeto foi criado e não foi divulgado, perdendo assim uma grande oportunidade de mostrar meu potencial.", "2004", "game_violenchico.jpg", "jogos/game_violenchico_screenshots800x600.jpg", "");

//Arte
$crs = array("crs", "CRS Prod.", "CRS Produções Artísticas", "Melhoramento do logotipo da empresa CRS Produções", "fev/2009", "arte_crs.jpg", "arte/arte_crs.jpg", "");
...
<div class="content" id="divaoContent">
	...
	<div id="portfolioVisualizador">
		...
		if($_GET['projeto']) {
			...
			<br />
			<p><span class="pDestaque">Descrição:</span> '.${$_GET['projeto']}[3].'</p>
			<p><span class="pDestaque">Data Entrega:</span> '.${$_GET['projeto']}[4].' </p>';
			//Se não houver link precisa ter uma mensagem diferenciada, e viva a usabilidade
			
			if(!${$_GET['projeto']}[7]=="")
			echo '<p><span class="pDestaque">Link:</span> <a href=\''.${$_GET['projeto']}[7].'\' target=\'_blankc\'>'.${$_GET['projeto']}[7].'</a></p>';
			
			echo '
			<br />
			<a href=\'imagens/portfolio/grandes/'.${$_GET['projeto']}[6].'\' rel="ibox"><img src="imagens/portfolio/grandes/'.${$_GET['projeto']}[6].'" alt="Screenshot de '.${$_GET['projeto']}[2].'" /></a>
			';
		} else {
			echo 
			...
			<br />
			<br />
			<p>São 4 categorias de projetos, que representam minhas áreas de atuação profissional!</p>
			<br />
			<br />
